...
execute unless data block ~ ~ ~ Items[{Slot:0b}] run function oo:fill/campfire/add {slot:0}
data modify storage oo:macro item.Slot set value 1b
execute unless data block ~ ~ ~ Items[{Slot:1b}] run function oo:fill/campfire/add {slot:1}
data modify storage oo:macro item.Slot set value 2b
execute unless data block ~ ~ ~ Items[{Slot:2b}] run function oo:fill/campfire/add {slot:2}
data modify storage oo:macro item.Slot set value 3b
execute unless data block ~ ~ ~ Items[{Slot:3b}] run function oo:fill/campfire/add {slot:3}
